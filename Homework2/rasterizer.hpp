...
namespace rst
{
    ...
    private:
        ...
        void MSAA(float x, float y, const Triangle& t);
    ...
    private:
        ...
        std::vector<Eigen::Vector3f> frame_buf, frame_buf_ss;

        std::vector<float> depth_buf, depth_buf_ss;
        int get_index(int x, int y);
        int get_index_ss(float x, float y);
